...
import { Calendar, Clock, MapPin, Video, Link as LinkIcon, RefreshCw, AlertCircle } from 'lucide-react';
      ...
      <WidgetShell>
        <div className="text-center py-6">
          ...
          <p className="text-xs text-muted-foreground mt-1 max-w-xs mx-auto">
            See your upcoming meetings right here on the dashboard.
          </p>
          <button
              ...
              {group.items.map((e) => {
                ...
                const row = (
                  <motion.div
                    ...
                    transition={{ delay }}
                    className="flex items-center gap-3 p-2.5 rounded-xl border border-border/60 hover:bg-muted/40 transition-colors"
                  >
