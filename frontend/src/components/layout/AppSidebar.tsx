...
const navItems: NavItem[] = [
  ...
  { label: 'Procurement', icon: Building2, path: '/procurement', roles: ['architect', 'contractor'] },
  { label: 'Timeline', icon: Calendar, path: '/timeline', roles: ['architect', 'contractor', 'client'] },
