...
export default function TopNavbar() {
  ...
  return (
    <header className="h-16 bg-card/60 backdrop-blur-xl border-b border-border/60 flex items-center justify-between px-6 sticky top-0 z-20">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-xl text-muted-foreground hover:bg-muted/60 hover:text-foreground transition-colors text-sm"
          >
            <Search className="w-4 h-4" />
            <span className="hidden md:inline text-xs text-muted-foreground">Search...</span>
            <kbd className="hidden md:inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-md bg-muted text-[10px] text-muted-foreground border border-border/60">
          ...
          <AnimatePresence>
            {searchOpen && (
              <motion.div
                ...
                className="absolute right-0 top-12 w-80 bg-card rounded-2xl border border-border shadow-2xl shadow-foreground/5 overflow-hidden"
              >
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            className="p-2 rounded-xl text-muted-foreground hover:bg-muted/60 hover:text-foreground transition-colors relative"
          >
            ...
            {notifOpen && (
              ...
              >
                ...
                <div className="max-h-80 overflow-y-auto">
                  {notifications.slice(0, 5).map(n => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 hover:bg-muted/60 transition-colors border-b border-border/40 last:border-0 ${!n.read ? 'bg-primary/5' : ''}`}
                    >
                ...
                <Link
                  ...
                  className="block text-center py-3 text-xs text-primary hover:bg-muted/60 transition-colors border-t border-border/60"
                >
